...
<title>{title} — Generative-Techno ZynthianMaschine MKII</title>
<link rel="stylesheet" href="style.css">
<script src="{mermaid_cdn}"></script>
<script>mermaid.initialize({{ startOnLoad: true, theme: 'base', themeVariables: {{
  primaryColor: '#17171b', primaryTextColor: '#f0f0f4',
  primaryBorderColor: '#b4b4bc', lineColor: '#b4b4bc',
  secondaryColor: '#1f1f24', tertiaryColor: '#131316',
  actorBkg: '#17171b', actorTextColor: '#f0f0f4',
  actorBorder: '#b4b4bc', actorLineColor: '#b4b4bc',
  activationBkgColor: '#26262c', activationBorderColor: '#b4b4bc',
  signalColor: '#b4b4bc', signalTextColor: '#17171b',
  labelBoxBkgColor: '#17171b', labelBoxBorderColor: '#b4b4bc', labelTextColor: '#f0f0f4',
  noteBkgColor: '#1f1f24', noteTextColor: '#f0f0f4', noteBorderColor: '#b4b4bc',
  titleColor: '#f0f0f4',
  clusterBkg: '#1f1f24', clusterBorder: '#b4b4bc', clusterTextColor: '#f0f0f4',
  fillType0: '#17171b', fillType1: '#1f1f24', fillType2: '#131316'
}} }});</script>
</head>
<body>
<header id="site-header">
  <a href="index.html">Generative-Techno ZynthianMaschine MKII</a> &mdash; Build Guide
</header>
<div id="layout">
{sidebar}
<main>
...
#site-header {
  ...
  box-shadow: 0 2px 0 rgba(180,180,190,0.2);
}
#site-header a { color: #b4b4bc; text-decoration: none; }
#site-header a:hover { color: #e6e6ea; }
...
.track-header:hover { color: #e6e6ea; }
.track-arrow {
  font-size: 0.65rem;
...
#sidebar li a:hover { background: rgba(180,180,190,0.08); color: #e6e6ea; }
#sidebar li a[aria-current="page"] {
  background: rgba(180,180,190,0.12);
  color: #b4b4bc;
  font-weight: 600;
  border-left: 2px solid #b4b4bc;
...
#nav-search::placeholder { color: rgba(150,150,158,0.35); }
#nav-search:focus { outline: 1px solid #b4b4bc; border-color: #b4b4bc; background: rgba(255,255,255,0.05); }
#search-results ul { list-style: none; margin: 0; padding: 0; }
#search-no-results { padding: 0.4rem 1rem; color: #6a6a72; font-size: 0.85rem; margin: 0; }
.search-result a { display: block; padding: 0.5rem 1rem; text-decoration: none; border-bottom: 1px solid rgba(180,180,190,0.1); }
.search-result a:hover, .result-focused a { background: rgba(180,180,190,0.08); }
.result-focused a { outline: 1px solid #b4b4bc; outline-offset: -1px; }
.result-title { display: block; font-weight: 600; font-size: 0.88rem; color: #e6e6ea; }
.result-heading { display: block; font-size: 0.75rem; color: #b4b4bc; margin-top: 0.1rem; }
.result-excerpt { display: block; font-size: 0.78rem; color: #78787f; margin-top: 0.12rem; line-height: 1.4; }
mark { background: rgba(180,180,190,0.25); color: inherit; padding: 0 2px; border-radius: 1px; }
...
/* --- Headings --- */
h1, h2, h3, h4 { color: #f0f0f4; line-height: 1.3; font-weight: 600; }
...
h1::after {
  ...
  margin-top: 0.45rem;
  height: 2px;
  background: linear-gradient(to right, #b4b4bc 0%, #b4b4bc 40%, transparent 100%);
}
...
h2::after {
  ...
  margin-top: 0.25rem;
  height: 1px;
  background: linear-gradient(to right, rgba(180,180,190,0.6) 0%, rgba(180,180,190,0.1) 50%, transparent 100%);
}

h3 { font-size: 1.05rem; color: #d0d0d8; margin-top: 1.6rem; margin-bottom: 0.45rem; }
h4 { font-size: 0.95rem; color: #b0b0b8; margin-top: 1.1rem; }

p { margin: 0 0 0.9rem; color: #bcbcc4; }

a { color: #b4b4bc; text-decoration: underline; text-decoration-color: rgba(180,180,190,0.3); }
a:hover { color: #e6e6ea; text-decoration-color: rgba(230,230,234,0.6); }

/* --- HR --- */
hr {
  border: none;
  height: 1px;
  background: linear-gradient(to right, transparent 0%, rgba(180,180,190,0.4) 15%, rgba(180,180,190,0.4) 85%, transparent 100%);
  margin: 1.75rem 0;
}
...
th, td { padding: 0.42rem 0.8rem; border: 1px solid rgba(180,180,190,0.2); }
td { color: #bcbcc4; }
tr:nth-child(even) td { background: rgba(180,180,190,0.03); }
tr:hover td { background: rgba(180,180,190,0.07); }
...
li { margin-bottom: 0.2rem; color: #bcbcc4; }
...
@media (max-width: 900px) {
  ...
  #sidebar { width: 100%; height: auto; position: static; border-right: none; border-bottom: 1px solid rgba(180,180,190,0.3); }
...
.copy-btn:hover { background: rgba(180,180,190,0.18); color: #e6e6ea; }
.copy-btn.copied { background: rgba(180,180,190,0.2); color: #e6e6ea; }
...
.anchor-link:hover, .anchor-link.anchor-copied { color: #b4b4bc; }
...
.toc-collapse-btn:hover { color: #e6e6ea; }
...
#toc li a:hover, #toc li a.toc-active { color: #b4b4bc; }
...
def main():
    ...
    # The sprint board reads MD/inwork.md, todo.md and done.md, which exist only
    # in the zynth-docs repository this generator came from.
